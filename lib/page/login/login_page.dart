        ...
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
              labelText: controller.isModePhone.value ? 'Số điện thoại' : 'Tài khoản',
            ),
            onChanged: (text) {
            ...
            children: [
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: controller.isModePhone.value ? Colors.transparent : Colors.amberAccent,
                      borderRadius: BorderRadius.circular(30),
                    ),
                    alignment: Alignment.center,
                    child: Text(
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: controller.isModePhone.value ? Colors.amberAccent : Colors.transparent,
                      borderRadius: BorderRadius.circular(30),
                    ),
                    alignment: Alignment.center,
                    child: Text(
